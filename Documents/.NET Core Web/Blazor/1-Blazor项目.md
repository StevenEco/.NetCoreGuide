...
![ServerSide](https://images.cnblogs.com/cnblogs_com/WarrenRyan/1643641/o_200818021644blazor-server.png)
使用这种方式意味着对于服务器的带宽以及性能要求会极其之高，但是对于一些需要使用到SignalR的应用以及一些访问量不大的地方使用SignalR也许会有不小的用途。

一次点击事件在websockets中的传输

![click](https://images.cnblogs.com/cnblogs_com/WarrenRyan/1643641/o_200818021735blazor_click.png)

并且在无操作的情况下，网页仍需要定期发送心跳包确认服务器状态，若服务器无响应，则整个网页停止服务

![shutdown](https://images.cnblogs.com/cnblogs_com/WarrenRyan/1643641/o_200818021828shutdown.png)
...
![client](https://images.cnblogs.com/cnblogs_com/WarrenRyan/1643641/o_200818021955blazor-webassembly.png)
