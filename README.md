...
PPT和Code以及Document需要一起结合起来看，其中Document写的最详细，里面包含了很多内容，PPT则适合学完后的总结，Code中有很多注释和DEMO，个人认为Code和Document结合起来看然后再完成练习的题目，基本上就能掌握一节的内容。学习该内容需要一些CSE的基础作为底子。

## 内容

列出的连接表示已经更新，C#教程分为了初中高三个部分构成，其中初级教程多为基础的一些语法教程，中级教程则更注重各种实用的类的使用方法或者是C#中别具一格的好用的特性，高级篇则侧重于代码的设计、调优和新技术的运用手段。
